...
def send_email_task(self, subject, body, recipients, html_template=None, context=None):
    ...
    try:
        ...
        mark_job_failure(task_id, reason=str(exc))
        raise
    mark_job_success(task_id, started_monotonic=started)
